...
Quote.create(
  category: :motivation,
  text: "You must not only aim right, but draw the bow with all your might.",
...
Quote.create(
  category: :motivation,
  text: "The road to Easy Street goes through the sewer.",
  author: "John Madden"
)
...
Quote.create(
  category: :motivation,
  text: "You've got to bumble forward into the unknown.",
  author: "Frank Gehry"
)
...
Quote.create(
  category: :motivation,
  text: "There are no short cuts to any place worth going.",
...
Quote.create(
  category: :motivation,
  text: "I will go anywhere as long as it is forward.",
...
Quote.create(
  category: :motivation,
  text: "Choosing a goal and sticking to it changes everything.",
  author: "Scott Reed"
)
...
Quote.create(
  category: :motivation,
  text: "You never regret being kind.",
  author: "Nicole Shepherd"
)

Quote.create(
  category: :motivation,
  text: "Do what you have always done and you'll get what you have always got.",
  author: "Sue Knight"
)

Quote.create(
  category: :motivation,
  text: "Happiness is where we find it, but very rarely where we seek it.",
  author: "J. Petit Senn"
)

Quote.create(
  category: :motivation,
  text: "Being responsible sometimes means pissing people off.",
  author: "Colin Powell"
)
...
Quote.create(
  category: :motivation,
  text: "You wouldn't worry so much about what others think of you if you realized how seldom they do.",
  author: "Eleanor Roosevelt"
)
...
Quote.create(
  category: :motivation,
  text: "One's best success comes after their greatest disappointments.",
...
Quote.create(
  category: :motivation,
  text: "If you want to live a happy life, tie it to a goal, not to people or objects.",
  author: "Albert Einstein"
)
...
Quote.create(
  category: :motivation,
  text: "I have never in my life learned anything from any man who agreed with me.",
...
Quote.create(
  category: :motivation,
  text: "Don't blow off another's candle for it won't make yours shine brighter.",
  author: "Jaachynma Agu"
)
